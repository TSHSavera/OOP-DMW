 ...
 * @author Admin
 */
public class EducationTable extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Action", "Category", "School", "Course", "Academic Year", "Educational Attained"
            }
        ) {
    ...
    //Create a method that will update the table based on the data from the database
    public static void updateTable() {
        ...
        SQLResultParser sqlResultParser = new SQLResultParser() {
            ...
            public ArrayList<Map> sqlQuery() {
                ...
                SQLHandler sqlHandler = new SQLHandler();
                //Create a new query
                String query = "SELECT * FROM educational WHERE UserID = " + Auth.userId;
                //Execute the query
                sqlHandler.createQuery(query).executeQuery();
                //Return the results
